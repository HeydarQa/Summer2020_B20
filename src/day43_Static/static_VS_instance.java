...
public class static_VS_instance {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(obj1.staticVariable); // not prefer
        System.out.println(obj2.staticVariable); // not prefer

        System.out.println(static_VS_instance.staticVariable); // prefers\
